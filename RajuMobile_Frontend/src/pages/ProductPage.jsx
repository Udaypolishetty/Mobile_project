            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden">
                <button
                  ...
                  className="w-9 h-9 flex items-center justify-center hover:bg-gray-100 text-lg font-bold text-gray-600 transition"
                >
                  −
                </button>
              ...
              <button
                ...
                className={`flex-1 font-bold py-3 rounded-xl flex items-center justify-center gap-2 transition ${
                  added
                    ...
                    : "bg-black hover:bg-cyan-600 text-white disabled:bg-gray-200 disabled:text-gray-400"
                }`}
              >
                <FaShoppingCart />
              ...
              <button
                ...
                className={`px-4 py-3 rounded-xl border-2 transition ${
                  isWishlisted(product.id)
                    ...
                    : "border-gray-200 text-gray-400 hover:border-pink-400 hover:text-pink-400"
                }`}
              >
                <FaHeart />
              </button>
