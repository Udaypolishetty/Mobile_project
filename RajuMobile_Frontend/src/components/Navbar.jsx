...
<div style={{ background: "linear-gradient(90deg,#0e7490,#1d4ed8,#0e7490)", overflow: "hidden" }}
  ...
  <div className="marquee-text px-4">
    ⚡ ALL TYPES OF MOBILE SERVICES AVAILABLE &nbsp;•&nbsp; 🤝 REFER ANYONE & GET AN INSTANT DISCOUNT &nbsp;•&nbsp; 
    🛵 FREE PICKUP & DELIVERY UPTO 12 KM &nbsp;•&nbsp; ⏱️ FAST & RELIABLE REPAIRS DONE SAME DAY
  </div>
</div>
        ...
        <div className="flex md:hidden items-center justify-between px-4 py-3"
          ...
          <Link to="/" className="absolute left-1/2 -translate-x-1/2">
            <img src="/mobile_logos.png" alt="Raju's Mobile" className="h-12 bg-white w-auto object-contain" style={{ mixBlendMode: "lighten" }} />
          </Link>
          ...
          <div className="md:hidden mobile-menu-overlay fixed inset-0 z-[999] flex flex-col"
            ...
            <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
              ...
              <Link to="/" onClick={() => setMenuOpen(false)}>
                <img src="/mobile_logos.png" alt="Raju's Mobile" className="h-10 w-auto object-contain" />
              </Link>
          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="grid grid-cols-3 items-center gap-6">
              ...
              <Link to="/" className="group">
                <img src="/mobile_logos.png" alt="Raju's Mobile"
