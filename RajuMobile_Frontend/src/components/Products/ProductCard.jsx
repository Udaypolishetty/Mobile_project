...
//           {/* Badge */}
//           {product.badge && (
//             <span className={`pc-badge ${product.badge.toLowerCase().includes("sale") ? "pc-badge-sale"
...
//               className={`pc-atc ${!product.inStock ? "pc-atc-disabled"
//                   : added ? "pc-atc-added"
//                     : "pc-atc-default"
//                 }`}
//             >
...
//               ) : added ? (
//                 <>
//                   <FaCheck className="check-anim" style={{ fontSize: "11px" }} />
//                   Added!
//                 </>
//               ) : (
//                 <>
